...
const requiredColumns = {
  tenants: ['id', 'name', 'slug', 'plan', 'url', 'revalidation_secret', 'mp_access_token', 'mp_public_key', 'smtp_user', 'contact_email', 'envia_access_token', 'correo_argentino_customer_id', 'origin_postal_code'],
